...
public class MonitoringController {
    ...
    @RequestMapping(value = "/sendAbnormalApplicationStatus", method = RequestMethod.GET)
    @ResponseBody
    public ApplicationStatus sendAbnormalApplicationStatus() {
        log.info("Send Abnormal application status");
        eventStore.tell(new ApplicationAbnormalEvent(), null);

        return ApplicationStatusProjection.askApplicationStatus(applicationStatusProjection);
    }
    
    @RequestMapping(value = "/queryAllEvents", method = RequestMethod.GET)
    @ResponseBody
    public List<Event> queryAllApplicationEvent() {
        log.info("queryAllApplicationEvent");
